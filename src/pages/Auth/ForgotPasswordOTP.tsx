  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F3F4F6]">
      <div className="card-glass p-8 w-full max-w-md">
        <h2 className="text-2xl font-bold text-center mb-6">Forgot Password OTP</h2>
        <p className="text-gray-600 text-center">Enter the OTP sent to your email to proceed.</p>
        <div className="mt-4">
