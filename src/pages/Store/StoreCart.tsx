...
const StoreCart: React.FC = () => {
  const [cartItems, setCartItems] = React.useState([
    { id: 1, name: 'Designer Silk Saree', price: 2499, quantity: 1, image: 'https://images.unsplash.com/photo-1610030469627-3b5e8e6c8d1f?w=200&h=250&fit=crop', color: 'Red', size: 'M' },
    { id: 2, name: 'Banarasi Silk Saree', price: 3599, quantity: 2, image: 'https://images.unsplash.com/photo-1610030469627-3b5e8e6c8d1f?w=200&h=250&fit=crop', color: 'Gold', size: 'L' },
  ]);
